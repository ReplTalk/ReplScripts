...
## [Workaround to avoid 313 error](Workaround_to_avoid_313_error.sql)
...
This error should be handled by the developer. [This sample script](Workaround_to_avoid_313_error.sql) is an example to avoid error 313 when the lsn value parameter used in `fn_cdc_get_all_changes` is beyond the time of highest LSN, or before the time of the earliest LSN. 
